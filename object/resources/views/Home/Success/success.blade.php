...
<html>
	<head>
		<link rel="stylesheet"  type="text/css" href="/Home/shopping/AmazeUI-2.4.2/assets/css/amazeui.css"/>
		<link href="/Home/shopping/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		<link href="/Home/shopping/basic/css/demo.css" rel="stylesheet" type="text/css" />
		<link href="/Home/shopping/css/sustyle.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="/Home/shopping/basic/js/jquery-1.7.min.js"></script>
		<!-- 听云监控 -->
	...
	<body>
		...
		<div style="background: white;">
	    	<div class="cart_top">
	        <div class="user_box" id="JS_user_box"><div>聚美优品欢迎您，<a href="http://passport.jumei.com/i/account/login">登录</a><i class="tips">|</i><a href="http://passport.jumei.com/i/account/signup">免费注册</a></div></div>
	    	</div>
				...
				<div class="status">
					...
					<div class="successInfo">
	     				...
	     				<div class="option">
	        				...
	        				<a href="/home/sign/order/0" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
	        				<a href="/home/sign/order/0" class="J_MakePoint">查看<span>交易详情</span></a>
	     				</div>
	    			</div>
	  			</div>
			</div>
